...
public interface IWhatsAppService
{
	...
	Task<WhatsAppMessage?> QueueInvoiceFinalizedNotificationAsync(Guid invoiceId, string? publicInvoiceUrl = null, string? rawInvoiceToken = null, CancellationToken cancellationToken = default);
