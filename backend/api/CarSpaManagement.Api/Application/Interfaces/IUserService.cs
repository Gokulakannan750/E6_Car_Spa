...
public interface IUserService
{
    ...
    Task<UserDto> CreateUserAsync(CreateUserRequest request, Guid currentUserId, bool isOwner, CancellationToken cancellationToken = default);
    Task<UserDto> UpdateUserAsync(Guid id, UpdateUserRequest request, Guid currentUserId, bool isOwner, CancellationToken cancellationToken = default);
