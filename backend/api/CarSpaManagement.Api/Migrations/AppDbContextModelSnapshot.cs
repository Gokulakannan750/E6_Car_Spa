...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarSpaManagement.Api.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CarSpaManagement.Api.Domain.Entities.BusinessProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CarSpaManagement.Api.Domain.Entities.Staff", b =>
                {
                    ...
                    b.Property<string>("AadhaarDocumentFileName")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");

                    b.Property<string>("AadhaarDocumentContentType")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<long?>("AadhaarDocumentSize")
            ...
            modelBuilder.Entity("CarSpaManagement.Api.Domain.Entities.StaffAdvance", b =>
                {
                    ...
                    b.Property<Guid?>("ObsoletedByUserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CarSpaManagement.Api.Domain.Entities.StaffAdvance", b =>
                {
                    b.HasOne("CarSpaManagement.Api.Domain.Entities.User", "ObsoletedByUser")
                        .WithMany()
                        .HasForeignKey("ObsoletedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CarSpaManagement.Api.Domain.Entities.User", "SettledByUser")
                        .WithMany()
