...
class OutstandingInvoiceRowModel {
  ...
  const OutstandingInvoiceRowModel({
...
class OutstandingInvoiceReportResponseModel {
  final List<OutstandingInvoiceRowModel> items;
  final int totalCount;
  final int page;
  final int pageSize;
  final OutstandingInvoiceSummaryModel summary;
